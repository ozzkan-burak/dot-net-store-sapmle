  ...
  public class ProductConfig : IEntityTypeConfiguration<Product>
  {
    ...
    public void Configure(EntityTypeBuilder<Product> builder)
    {
      ...
      builder.HasData(
        ...
        new Product() { ProductId = 6, CategoryId = 1, ImageUrl = "/images/6.jpg", ProductName = "History OF Human", Price = 1_000 },
        new Product() { ProductId = 7, CategoryId = 1, ImageUrl = "/images/7.jpg", ProductName = "Tüfek Mikrop ve Çelik", Price = 2_000 }
      );
    }
  }
}